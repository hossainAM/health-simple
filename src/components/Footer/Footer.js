    ...
    return (
       <footer className="text-gray-600 body-font bg-red-600" style={pathname.includes('blogs') ? {display: 'none'} : {display: 'flex'}}>
            <div className="container px-5 py-8 mx-auto flex items-center sm:flex-row flex-col">
                ...
                <p className="text-sm text-gray-100 sm:ml-4 sm:pl-4 sm:border-l-2 sm:border-gray-200 sm:py-2 sm:mt-0 mt-4">© 2022 Health Simple —
                <a href="https://twitter.com/amhossain" className="text-gray-100 ml-1" rel="noopener noreferrer" target="_blank">@duinfs</a>
                </p>
